...
resource "validation_warning" "naming" {
  condition = local.naming != null
  summary   = "WARNING: Deprecation Notice, naming is not loger used, please remove this variable from your configuration"
}
