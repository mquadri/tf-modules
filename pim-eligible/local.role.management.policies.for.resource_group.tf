locals {
  role_mgmt_policies_for_resource_group_for_any = {
  ...
  role_mgmt_policies_for_resource_group_for_groups = {
    for flattened_role_mgmt_policies in flatten([
      for key, value in var.role_assignments_for_resource_groups : [
        for assignment_key, assignment_value in value.role_assignments : [
          {
  ...
  role_mgmt_policies_for_resource_group_for_users = {
    for flattened_role_mgmt_policies in flatten([
      for key, value in var.role_assignments_for_resource_groups : [
        for assignment_key, assignment_value in value.role_assignments : [
          {
  ...
  role_mgmt_policies_for_resource_groups = merge(
    local.role_mgmt_policies_for_resource_group_for_users,
    local.role_mgmt_policies_for_resource_group_for_groups,
    local.role_mgmt_policies_for_resource_group_for_any
  )
}