...
variable "infra_rg_db_name" {
  type        = string
  description = "name of the resource group for the databricks"
}
...
variable "infra_subnet_db_mgmt_name" {
  type        = string
  description = "name subnet used for db mgmt"
}

variable "infra_subnet_db_int_name" {
  type        = string
  description = "name subnet used for db int"
}
