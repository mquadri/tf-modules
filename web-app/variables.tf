...
variable "resource_group_name" {
  description = "Resource group name for where App Service will be deployed"
  type        = string
}

# web app (App Service) settings
variable "name" {
  type        = string
  default     = null
  description = "allow override of the App Service name"
}
...
variable "swift_connection_subnet_id" {
  type        = string
  description = "The subnet ID for the Swift connection to the web app."
  default     = null
}
