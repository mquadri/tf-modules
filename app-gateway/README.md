...
### <a name="module_avm-res-network-applicationgateway"></a> [avm-res-network-applicationgateway](#module\_avm-res-network-applicationgateway)
...
- [azurerm_subnet.gateway_subnet](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/subnet) (data source)
...
Description: - `name` -  The Name of this Gateway IP Configuration.
...
### <a name="input_subnet_rg"></a> [subnet\_rg](#input\_subnet\_rg)
...
### <a name="input_waf_firewall_policy"></a> [waf\_firewall\_policy](#input\_waf\_firewall\_policy)
...
### <a name="output_application_gateway_combined_output"></a> [application\_gateway\_combined\_output](#output\_application\_gateway\_combined\_output)
