...
variable "base_policy_name" {
  type        = string
  description = " The name which should be used for the Base Firewall Policy."
  default     = null
}
...
variable "base_policy_resource_group_name" {
  type        = string
  description = "The name of the Resource Group where the Base Firewall Policy exists. "
  default     = null
}
