...
variable "resource_group_name" {
  description = "The name of the resource group to which the storage account should be deployed"
  type        = string
}
...
variable "name" {
  ...
  validation {
    ...
    error_message = "The name must be between 3 and 24 characters, valid characters are lowercase letters and numbers.If we don't give the name, it will be created by local naming convention"
  }
}
