...
resource "validation_warning" "role_assignments_for_resources" {
  condition = var.role_assignments_for_resources != null
  summary   = "WARNING: Deprecation Notice, role_assignments_for_resources is not loger used, please remove this variable from your configuration"
}

resource "validation_warning" "user_assigned_managed_identities_by_resource_group_and_name" {
  condition = var.user_assigned_managed_identities_by_resource_group_and_name != null
  summary   = "WARNING: Deprecation Notice, user_assigned_managed_identities_by_resource_group_and_name is not loger used, please remove this variable from your configuration"
}

resource "validation_warning" "system_assigned_managed_identities_by_principal_id" {
  condition = var.system_assigned_managed_identities_by_principal_id != null
  summary   = "WARNING: Deprecation Notice, system_assigned_managed_identities_by_principal_id is not loger used, please remove this variable from your configuration"
}

resource "validation_warning" "role_definitions" {
  condition = var.role_definitions != null
  summary   = "WARNING: Deprecation Notice, role_definitions is not loger used, please remove this variable from your configuration"
}
