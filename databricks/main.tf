...
resource "azurerm_subnet" "public" {
  name = var.mgmt_public_snet_name != null ? var.mgmt_public_snet_name : "snet-db-mgmt-${local.naming}"
...
resource "azurerm_subnet" "private" {
  name                 = var.int_private_snet_name != null ? var.int_private_snet_name : "snet-db-int-${local.naming}"
  resource_group_name  = data.azurerm_resource_group.vnet-rg.name
  virtual_network_name = data.azurerm_virtual_network.vnet.name
